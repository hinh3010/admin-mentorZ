...
import { Box, CardContent, Fab } from '@mui/material';
...
const Error404 = () => {
    ...
    return (
        <CardContent sx={{ width: '100vw', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Box sx={{ width: '100%', height: '100%', overflow: 'hidden' }}>
                <svg
                    ...
                    <rect x="99.80546" y="689.02332" width="24" height="43" transform="translate(-31.32451 -62.31008) rotate(0.67509)"
                        fill="#2f2e41" />
                    <rect x="147.80213" y="689.58887" width="24" height="43" transform="translate(-31.31452 -62.87555) rotate(0.67509)"
                        fill="#2f2e41" />
                    <ellipse cx="119.54569" cy="732.61606" rx="7.5" ry="20" transform="translate(-654.1319 782.47948) rotate(-89.32491)"
                        fill="#2f2e41" />
                    ...
                    <path
                        ...
                        transform="translate(-39.70387 -61.04208)" fill="#caff63" />
                    <path
                    ...
                    <ellipse cx="767.887" cy="732.00275" rx="20" ry="7.5" transform="translate(-220.8593 196.83312) rotate(-17.08345)"
                        fill="#2f2e41" />
            ...
            <a href={isAuthenticated ? '/' : '/login'} style={{
                position: 'absolute',
                top: '50vh',
            }}>
                <Fab variant="extended" >
                    <NavigationIcon sx={{ mr: 1 }} />
                    {isAuthenticated ? 'Go Home' : 'Login now'}
                </Fab>
            </a>
        </CardContent >
    )
