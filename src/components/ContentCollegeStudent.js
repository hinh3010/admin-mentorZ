...
export default function ContentCollegeStudent() {
    ...
    const { education } = detailUser;

    const renderSubjects = () => {
        return <Slider {...categorysettings}>
                ...
                >
                    ...
                    >
                        <div style={{ color: `#C75517` }} className="bg-white mx-auto home__class">
                            <img src={require('../assets/images/devWeb.png')} alt="KMA" style={{ borderRadius: '50%' }} />
                        </div>
    ...
    useEffect(() => {
        dispatch(getClassAction(education.id, "STUDENT"));
    }, [])
    ...
    return (
        <Fragment>
            ...
            <div className="home-post container-fluid mx-3">
                <div className="row w-100 home-post__row">
                    ...
                    <div className="col-12 col-xl-9">
                        <div className="home-post__input" >
                            <input className="cursor-pointer" placeholder="Hỏi bài ngay, các Mentor đã sẵn sàng hỗ trợ bạn rồi đó!" disabled />
                        </div>
                        <div className="d-flex justify-content-between">
                            <div style={{ background: '#0055FF' }} className="home-post__btn mont-font">
                                <i>
                                    <VanbanSvg />
                                </i>
                                <span>Dạng văn bản</span>
                            </div>
                            <div style={{ background: '#FE9431' }} className="home-post__btn mont-font">
                                <i>
                                    <HinhanhSvg />
                                </i>
                                <span>Dạng hình ảnh</span>
                            </div>
                            <div style={{ background: '#FF0000' }} className="home-post__btn mont-font">
                                <i>
                                    <VideoSvg />
                                </i>
            ...
            <div className="col-lg-12 pt-4 mb-3 home__class-title">
                <div className="d-flex justify-content-between">
                    <h2 className="fw-400 font-lg home__title d-block">
                        Các môn học <b> của {education.name}</b>
                    </h2>
            ...
            <div className="col-lg-12 pt-4 mt-3 home__class-title">
                <div className="d-flex justify-content-between">
                    <h2 className="fw-400 font-lg home__title d-block">
                        Ôn thi chứng chỉ quốc tế <b> - kỹ năng mềm</b>
                    </h2>
                    <span className="float-right home__seeMore">
                        Xem thêm
                    </span>
